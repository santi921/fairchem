...
| **Tasks** | S2EF-Total, IS2RE-Total, IS2RS |
| **Focus** | Oxide electrocatalysts |
| **Energy Type** | DFT total energies |
| **Paper** | [ACS Catalysis 2023](https://doi.org/10.1021/acscatal.2c05426) |
| **License** | [CC-BY-4.0](https://creativecommons.org/licenses/by/4.0/legalcode) |
:::

:::{note}
OC22 models are trained on DFT total energies, in contrast to OC20 models which are trained on adsorption energies.
:::
