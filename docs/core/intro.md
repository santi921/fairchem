...
:::{card} **Universal Model for Atoms (UMA)** - Current SOTA
:link: uma
...
**Paper:** <https://ai.meta.com/research/publications/uma-a-family-of-universal-models-for-atoms/>
:::

:::{card} **equivariant Smooth Energy Network (eSEN)**
...
:::{card} **Equivariant Transformer V2 (EquiformerV2)**
...
:::{card} **Equivariant Spherical Channel Network (eSCN)**
...
:::{card} **Spherical Channel Network (SCN)**
